                            ...
                            <tbody>
                                @foreach ($news as $news)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <a href="{{ route('admin.news.edit', $news->id) }}" class="text-secondary font-weight-bold text-xs"
                                                data-toggle="tooltip" data-original-title="Edit user">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                        </td>
                                        <td class="align-middle text-center">
                                            <a href="{{ route('admin.news.destroy', $news->id) }}" class="text-secondary font-weight-bold text-xs"
